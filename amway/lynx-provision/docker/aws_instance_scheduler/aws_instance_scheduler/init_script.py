...
table_name_users = "amway-instance-scheduler-users"
table_name_groups = "amway-instance-scheduler-groups"
table_name_default_schedules = "amway-instance-scheduler-default-schedules"
