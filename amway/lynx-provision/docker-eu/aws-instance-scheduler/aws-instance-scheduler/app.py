...
CONFIG_TABLE_NAME = os.getenv("DYDB_TB_CONFIG")
USERS_TABLE_NAME = os.getenv("DYDB_TB_USER")  
GROUPS_TABLE_NAME = os.getenv("DYDB_TB_GROUPS") 
DEFAULT_SCHEDULES_TABLE_NAME = os.getenv("DYDB_TB_DEFAULT_SCHEDULE")
...
REGION_DYNAMO_DB = os.getenv("DYDB_TB_REGION")  # region where dynamodb tables for web app are stored
