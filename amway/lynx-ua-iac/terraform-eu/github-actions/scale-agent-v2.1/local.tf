locals {
  ...
  instance_type = {
    ...
    lynx    = "t3.large"
    lynx-ci = "t3.xlarge"
    microservices = "t3.medium"
    vip-reports-ua = "t3.medium"
    bank-identification-ua = "t3.medium"
    address-validation-ua = "t3.medium"
  }

  instance_ami = {
    default   = "${var.default_ami}"
    lynx      = "ami-0f91b041af1d8f2ea"
    ...
    microservices = "ami-0601951743aaf43f9"
    vip-reports-ua = "ami-0601951743aaf43f9"
    bank-identification-ua = "ami-0601951743aaf43f9"
    address-validation-ua = "ami-0601951743aaf43f9"
  }
  ...
  instance_subnet = {
    ...
    lynx = "subnet-0723968b9614ea2f0"
  }

  instance_kp = {
    default = "${var.default_kp}"
    microservices = "amway-eu-hybris-dev"
    vip-reports-ua = "amway-eu-hybris-dev"
    bank-identification-ua = "amway-eu-hybris-dev"
    address-validation-ua = "amway-eu-hybris-dev"
  }

  instance_sg = {
    default = "${var.default_sg}"
    microservices = "sg-0d99fec793ba3b700"
    vip-reports-ua = "sg-0d99fec793ba3b700"
    bank-identification-ua = "sg-0d99fec793ba3b700"
    address-validation-ua = "sg-0d99fec793ba3b700"
  }
