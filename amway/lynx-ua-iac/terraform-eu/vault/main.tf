data "template_file" "vault_user_data" {
  ...
  vars = {
    ...
    vault_data_bucket_name    = module.vault_data.this_s3_bucket_id
    vault_dynamodb_table_name = module.vault_dynamodb_table.this_dynamodb_table_id
...
module "vault_cluster" {
  ...
  vpc_security_group_ids      = [module.vault_cluster_sg_ec2.this_security_group_id]
