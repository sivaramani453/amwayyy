resource "aws_iam_instance_profile" "vault_iam_profile" {
  ...
  role = module.vault_iam_role.iam_role_name
}
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "${module.vault_data.s3_bucket_arn}",
                "${module.vault_data.s3_bucket_arn}/*"
            ]
        }
    ]
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "${module.vault_dynamodb_table.dynamodb_table_arn}",
                "${module.vault_dynamodb_table.dynamodb_table_arn}/stream/*"
            ]
        }
    ]
}
