...
var (
	contextsForEU = []string{"Build + JSP tests", "Spring context test", "UI Unit tests", "Unit + Web tests", "Sonar Ent test"}
	contextsForRU = []string{"Build + JSP tests", "Sonar Ent test", "Spring context test", "UI Unit tests", "Unit + Web tests", "Update test", "Integration tests part 1", "Integration tests part 2"}
)
