...
module "ingress" {
  ...
  set_list = {
    "tcp.25"                                      = "mailslurper/mailslurper:2500"
    "controller.extraArgs.tcp-services-configmap" = "ingress-nginx/ingress-nginx-tcp"
    "controller.service.ports.smtp"               = "25"
    "controller.service.targetPorts.smtp"         = "smtp"
  }
